...
public class Triangulo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lado = findViewById(R.id.txtLadoTriangulo);
        resultado = findViewById(R.id.lblResultadoTriangulo);
    }
    ...
    public void calcularResultado(View v){
        if(validar()) {
            ...
            res =n1*n2/2;
            Operacion op = new Operacion("area triangulo","altura : "+n1+", lado : "+n2,String.format("%.2f",res));
            op.guardar();
